...
var TabsPage = (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Vignesh\bar-qr-code-scanner\src\pages\tabs\tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Scan QR" tabIcon="qr-scanner"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="Scan Barcode" tabIcon="barcode"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Create QR" tabIcon="create"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"C:\Vignesh\bar-qr-code-scanner\src\pages\tabs\tabs.html"*/
        }),
...
var AboutPage = (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"C:\Vignesh\bar-qr-code-scanner\src\pages\about\about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Barcode Scanner\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <button ion-button full icon-left (click)="scanCode()" color="secondary">\n    <ion-icon name="qr-scanner"></ion-icon>Scan Code</button>\n\n  <ion-card *ngIf="scannedCode">\n    <ion-card-content>\n      Result from Scan: {{ scannedCode }}\n    </ion-card-content>\n  </ion-card>\n</ion-content>'/*ion-inline-end:"C:\Vignesh\bar-qr-code-scanner\src\pages\about\about.html"*/
        }),
...
var ContactPage = (function () {
    function ContactPage(navCtrl, barcodeScanner) {
        this.navCtrl = navCtrl;
        this.barcodeScanner = barcodeScanner;
        this.qrData = null;
        this.createdCode = null;
    ...
    ContactPage.prototype.createCode = function () {
        this.createdCode = this.qrData;
    };
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-contact',template:/*ion-inline-start:"C:\Vignesh\bar-qr-code-scanner\src\pages\contact\contact.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Generate QR Code\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-item>\n    <ion-input type="text" placeholder="MY QR Code data" [(ngModel)]="qrData">\n    </ion-input>\n  </ion-item>\n\n  <button ion-button full icon-left (click)="createCode()">\n    <ion-icon name="barcode"></ion-icon>Create Code</button>\n\n  <ion-card *ngIf="createdCode">\n    <ngx-qrcode [qrc-value]="createdCode"></ngx-qrcode>\n    <ion-card-content>\n      <p>Value: {{ createdCode }}</p>\n    </ion-card-content>\n  </ion-card>\n</ion-content>'/*ion-inline-end:"C:\Vignesh\bar-qr-code-scanner\src\pages\contact\contact.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_barcode_scanner__["a" /* BarcodeScanner */]])
    ], ContactPage);
    return ContactPage;
...
var HomePage = (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Vignesh\bar-qr-code-scanner\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      QR Code Creater\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <button ion-button full icon-left (click)="scanCode()" color="secondary">\n    <ion-icon name="qr-scanner"></ion-icon>Scan Code</button>\n\n  <ion-card *ngIf="scannedCode">\n    <ion-card-content>\n      Result from Scan: {{ scannedCode }}\n    </ion-card-content>\n  </ion-card>\n\n</ion-content>'/*ion-inline-end:"C:\Vignesh\bar-qr-code-scanner\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_barcode_scanner__["a" /* BarcodeScanner */]])
    ], HomePage);
    return HomePage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_ngx_qrcode2__ = __webpack_require__(284);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Vignesh\bar-qr-code-scanner\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Vignesh\bar-qr-code-scanner\src\app\app.html"*/
        }),
